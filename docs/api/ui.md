...
Returns the internal <span class-ref>Node</span> reference.
...
Assigns a update callable `ui_callable` to this UI, each time this particular UI changes, this callable is called, it must have only a single argument of type <span class-ref>UI</span>.

<h3 class-method>UI prop(String name, Variant value)</h3>

Sets a property of the <span class-ref>Node</span> with name `name` to `value`.
...
Smoothly animate the <span class-ref>Control</span>'s rect with linear interpolation with speed `speed`.

<h3 class-method>UI theme_variation(String theme_type)</h3>

Assign the <span class-ref>Control</span>'s `theme_type_variation` property to `theme_type`

<h3 class-method>UI shrink_begin()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` and `size_flags_vertical` to `SIZE_SHRINK_BEGIN`

<h3 class-method>UI fill()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` and `size_flags_vertical` to `SIZE_FILL`

<h3 class-method>UI expand()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` and `size_flags_vertical` to `SIZE_EXPAND`
...
Sets <span class-ref>Control</span>'s `size_flags_horizontal` and `size_flags_vertical` to `SIZE_SHRINK_CENTER`

<h3 class-method>UI shrink_end()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` and `size_flags_vertical` to `SIZE_SHRINK_END`

<h3 class-method>UI horizontal_shrink_begin()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` to `SIZE_SHRINK_BEGIN`

<h3 class-method>UI horizontal_fill()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` to `SIZE_FILL`

<h3 class-method>UI horizontal_expand()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` to `SIZE_EXPAND`
...
Sets <span class-ref>Control</span>'s `size_flags_horizontal` to `SIZE_SHRINK_CENTER`

<h3 class-method>UI horizontal_shrink_end()</h3>

Sets <span class-ref>Control</span>'s `size_flags_horizontal` to `SIZE_SHRINK_END`
...
Sets <span class-ref>Control</span>'s `anchor_*` and `offset_*` so that the Control's rect takes the entire parent's rect.

<h3 class-method>UI margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_*` and `offset_*` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI horizontal_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_left`, `anchor_right`, `offset_left` and `offset_right` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI vertical_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_top`, `anchor_bottom`, `offset_top` and `offset_bottom` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI left_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_left` and `offset_left` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI top_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_top` and `offset_top` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI right_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_right` and `offset_right` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI bottom_margin(Variant unit)</h3>

Sets <span class-ref>Control</span>'s `anchor_bottom` and `offset_bottom` so that the Control's rect has a margin relative to parent.
`unit` can be of type <span class-ref>int</span> or <span class-ref>float</span> for pixels, or <span class-ref>String</span> in pixels format: `"64px"` or relative format: `"5%"`

<h3 class-method>UI create(Node node)static</h3>

Creates a new <span class-ref>UI</span> binding it to `node`. `Node` must maintain reference to the returned UI and must have a function `ui_process(UI ui)`.
